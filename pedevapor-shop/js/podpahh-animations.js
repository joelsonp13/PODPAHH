...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const colors = ['rgba(45,122,255,0.6)', 'rgba(26,26,26,0.6)', 'rgba(139,92,246,0.5)'];
  ...
  /* --- 10. Custom cursor trail (removido) --- */

  /* --- 11. Nav shrink on scroll (throttled + passive p/ não travar o touch) --- */
  ...
  scrollBtn.addEventListener('mouseenter', () => {
    scrollBtn.style.boxShadow = '0 4px 25px rgba(26,26,26,0.5)';
    scrollBtn.style.transform = 'translateY(-2px)';
  });
  scrollBtn.addEventListener('mouseleave', () => {
    scrollBtn.style.boxShadow = '0 4px 15px rgba(26,26,26,0.3)';
  ...
  console.log('%c PODPAHH %c Loaded successfully ',
    'background: linear-gradient(135deg, #2d7aff, #1a1a1a); color: #fff; font-size: 14px; padding: 4px 8px; border-radius: 4px 0 0 4px; font-weight: bold;',
